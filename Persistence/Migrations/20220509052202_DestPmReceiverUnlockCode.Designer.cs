...
namespace shipping_service.Persistence.Migrations
{
    ...
    [Migration("20220509052202_DestPmReceiverUnlockCode")]
    partial class DestPmReceiverUnlockCode
    {
            ...
            modelBuilder.Entity("shipping_service.Persistence.Entities.Shipment", b =>
                {
                    ...
                    b.Property<int?>("SrcPmCourierUnlockCode")
                        .HasColumnType("integer");

                    b.Property<int?>("SrcPmSenderUnlockCode")
                        .HasColumnType("integer");
